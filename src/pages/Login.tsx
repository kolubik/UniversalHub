    ...
    <div className="max-w-md mx-auto py-24">
      ...
      >
        <div className="text-center space-y-3">
          ...
          <h1 className="text-4xl font-light tracking-tight text-white serif italic">Welcome <span className="cyber-text-gradient">Back</span></h1>
          <p className="text-xs text-gray-500 uppercase tracking-[0.3em] font-bold">Identity Verification Required</p>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 tracking-widest uppercase font-bold">
          New interface? <Link to="/register" className="text-cyan-400 hover:text-cyan-300">Request Access</Link>
        </p>
      </motion.div>
    </div>
  );
